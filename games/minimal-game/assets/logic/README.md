...
Future load operations must expose structured status/failure results and remain
compatible with deferred profiling under the [engine architecture](../../../../docs/architecture.md).

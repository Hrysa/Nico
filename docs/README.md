...
- [Roadmap](ROADMAP.md) — forward-looking engine work only.
- [`ui-performance-baseline.json`](ui-performance-baseline.json) — named benchmark baseline consumed by the UI benchmark harness.

Completed implementation plans and superseded design notes are intentionally omitted. Git history remains the source for historical decisions.

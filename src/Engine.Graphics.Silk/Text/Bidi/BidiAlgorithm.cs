...
namespace Engine.Graphics.Bidi
{
    ...
    internal sealed class BidiAlgorithm
    {
        ...
        /// </summary>
        private BidiArraySlice<BidiClass> _originalClasses;

        /// <summary>
        /// Paired bracket types as provided by caller
        /// </summary>
        private BidiArraySlice<BidiPairedBracketType> _pairedBracketTypes;

        /// <summary>
        /// Paired bracket values as provided by caller
        /// </summary>
        private BidiArraySlice<int> _pairedBracketValues;
        ...
        /// </summary>
        private BidiArraySlice<BidiClass> _workingClasses;

        /// <summary>
        /// The working classes buffer
        /// </summary>
        private BidiArrayBuilder<BidiClass> _workingClassesBuffer;

        /// <summary>
        /// A slice of the resolved levels
        /// </summary>
        private BidiArraySlice<sbyte> _resolvedLevels;

        /// <summary>
        /// The buffer underlying resolvedLevels
        /// </summary>
        private BidiArrayBuilder<sbyte> _resolvedLevelsBuffer;
        ...
        /// </summary>
        private BidiArrayBuilder<int> _x9Map;
        ...
        /// </summary>
        private BidiArrayBuilder<int> _isolatedRunMapping;
        ...
        /// being processed
        /// </summary>
        private MappedBidiArraySlice<BidiClass> _runResolvedClasses;

        /// <summary>
        /// A mapped slice of the original types for the isolating run currently
        /// being processed
        /// </summary>
        private MappedBidiArraySlice<BidiClass> _runOriginalClasses;

        /// <summary>
        /// A mapped slice of the run levels for the isolating run currently
        /// being processed
        /// </summary>
        private MappedBidiArraySlice<sbyte> _runLevels;

        /// <summary>
        /// A mapped slice of the paired bracket types of the isolating
        /// run currently being processed
        /// </summary>
        private MappedBidiArraySlice<BidiPairedBracketType> _runBiDiPairedBracketTypes;

        /// <summary>
        /// A mapped slice of the paired bracket values of the isolating
        /// run currently being processed
        /// </summary>
        private MappedBidiArraySlice<int> _runPairedBracketValues;
        ...
        /// </summary>
        public BidiArraySlice<sbyte> ResolvedLevels => _resolvedLevels;
        ...
        /// </summary>
        public void Process(
            BidiArraySlice<BidiClass> types,
            BidiArraySlice<BidiPairedBracketType> pairedBracketTypes,
            BidiArraySlice<int> pairedBracketValues,
            sbyte paragraphEmbeddingLevel,
            bool? hasBrackets,
            bool? hasEmbeddings,
            bool? hasIsolates,
            BidiArraySlice<sbyte>? outLevels)
        {
            // Reset state
            Reset();
        ...
        public sbyte ResolveEmbeddingLevel(BidiArraySlice<BidiClass> data)
        {
            // P2
        ...
        private void ProcessIsolatedRunSequence(BidiClass sos, BidiClass eos, int runLevel)
        {
            ...
            _runResolvedClasses = new MappedBidiArraySlice<BidiClass>(_workingClasses, isolatedRunMapping);
            _runOriginalClasses = new MappedBidiArraySlice<BidiClass>(_originalClasses, isolatedRunMapping);
            _runLevels = new MappedBidiArraySlice<sbyte>(_resolvedLevels, isolatedRunMapping);
            if (_hasBrackets)
            {
                _runBiDiPairedBracketTypes = new MappedBidiArraySlice<BidiPairedBracketType>(_pairedBracketTypes, isolatedRunMapping);
                _runPairedBracketValues = new MappedBidiArraySlice<int>(_pairedBracketValues, isolatedRunMapping);
            }
